...
const GAME_TYPES = {
  'chess':'win_loss','checkers':'win_loss','tic-tac-toe':'win_loss','connect-four':'win_loss',
  'reversi':'win_loss','battleship':'win_loss','dots-and-boxes':'win_loss','four-in-a-row':'win_loss',
  ...
  'pong':'win_loss',
  'yahtzee':'high_score','snake':'high_score','breakout':'high_score','asteroids':'high_score',
  'space-invaders':'high_score','flappy-jump':'high_score','fruit-slicer':'high_score',
  'endless-runner':'high_score','whack-a-mole':'high_score','helicopter-game':'high_score',
  'duck-hunt':'high_score','dodge-ball':'high_score','twenty-forty-eight':'high_score',
  'high-low':'high_score','color-flood':'high_score','sokoban':'high_score','block-puzzle':'high_score',
  ...
  'color-match':'high_score','simon-says':'high_score','trivia-quiz':'high_score',
  ...
  'rhythm-tap':'high_score','color-switch':'high_score','knife-throw':'high_score',
  ...
  'sliding-puzzle':'best_time','tower-of-hanoi':'best_time','lights-out':'best_time',
  'pipe-connect':'best_time','jigsaw':'best_time','maze-runner':'best_time',
