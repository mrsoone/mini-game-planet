...
export const games = [
  ...
  // ═══ EXPANSION PACK — 15 New Games ═══

  {
    name: 'Spades',
    slug: 'spades',
    category: 'Card',
    description: 'Play Spades online free with friends or AI. Bid, play tricks, and reach 500 points. Classic 4-player partnership trick-taking card game — no download needed.',
    icon: '♠',
    accent: '#DC2626',
  ...
  },
  {
    ...
    slug: 'hearts',
    category: 'Card',
    description: 'Play Hearts online free. Avoid hearts and the Queen of Spades — or shoot the moon. Classic 4-player card game in your browser, no download required.',
    icon: '♥',
    accent: '#DC2626',
  ...
  },
  {
    ...
    slug: 'gin-rummy',
    category: 'Card',
    description: 'Play Gin Rummy online free. Draw, discard, and form melds to knock or go gin. Classic 2-player card game with smart AI — play instantly in your browser.',
    icon: '🃏',
    accent: '#DC2626',
  ...
  },
  {
    ...
    slug: 'rummy-500',
    category: 'Card',
    description: 'Play Rummy 500 online free. Meld sets and runs, lay off on opponents, and race to 500 points. 2-4 player classic card game — no download needed.',
    icon: '🃏',
    accent: '#DC2626',
  ...
  },
  {
    ...
    slug: 'euchre',
    category: 'Card',
    description: 'Play Euchre online free with friends or AI. Call trump, play tricks, and go alone for big points. Fast-paced 4-player partnership card game — play instantly.',
    icon: '🂫',
    accent: '#DC2626',
  ...
  },
  {
    ...
    slug: 'cribbage',
    category: 'Card',
    description: 'Play Cribbage online free. Peg your way to 121 with 15s, pairs, and runs. Visual cribbage board, smart AI, and multiplayer — all in your browser.',
    icon: '🎴',
    accent: '#DC2626',
  ...
  },
  {
    ...
    slug: 'oh-hell',
    category: 'Card',
    description: 'Play Oh Hell online free. Bid exactly how many tricks you will take. Simple rules, deep strategy. 3-6 player card game — no sign-up, no download.',
    icon: '🔥',
    accent: '#DC2626',
  ...
  },
  {
    ...
    slug: 'pitch',
    category: 'Card',
    description: 'Play Pitch (Setback) online free. Bid for trump, score High-Low-Jack-Game. Fast 4-player partnership card game — play instantly in your browser.',
    icon: '🎯',
    accent: '#DC2626',
  ...
  },
  {
    ...
    slug: 'presidents',
    category: 'Card',
    description: 'Play Presidents online free. Shed your cards first to become President. Social hierarchy, card swapping between rounds — addictive 4-6 player party game.',
    icon: '👑',
    accent: '#DC2626',
  ...
  },
  {
    ...
    category: 'Card',
    description: 'Play Egyptian Rat Screw online free. Slap doubles, sandwiches, and face cards in this fast-paced real-time card game. 2-4 players — reflexes win!',
    icon: '✋',
    accent: '#DC2626',
  ...
  {
    name: 'Quick Draw',
    slug: 'pictionary-draw',
    category: 'Casual',
    description: 'Play Quick Draw online free with friends. One person draws, everyone guesses. Pictionary-style browser game for 2-8 players — no download, no sign-up.',
    icon: '🎨',
    accent: '#E11D48',
  ...
  },
  {
    ...
    slug: 'word-bomb',
    category: 'Word',
    description: 'Play Word Bomb online free. Type words containing the letter fragment before the bomb explodes! Fast-paced vocabulary game for 2-6 players.',
    icon: '💣',
    accent: '#D97706',
  ...
  },
  {
    ...
    slug: 'trivia-battle',
    category: 'Trivia',
    description: 'Play Trivia Battle online free. Race to answer questions faster than your opponents. First correct answer gets full points. 2-8 players, 500+ questions.',
    icon: '⚡',
    accent: '#6D28D9',
  ...
  },
  {
    ...
    slug: 'tank-battle',
    category: 'Arcade',
    description: 'Play Tank Battle online free. Control your tank, destroy opponents, and grab power-ups in this top-down arena shooter. 2-4 players, real-time action.',
    icon: '🪖',
    accent: '#0891B2',
  ...
  },
  {
    ...
    slug: 'battle-snake',
    category: 'Arcade',
    description: 'Play Battle Snake online free. Classic snake but multiplayer — eat food, grow, and outlast your opponents. 2-4 player real-time action in your browser.',
    icon: '🐍',
    accent: '#0891B2',
